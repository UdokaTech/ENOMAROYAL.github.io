...
<?php
						...
						{	
							...
							if($st=="Conform")
							{
								...
								if($f1=="NONE" )
								{
									echo "<script type='text/javascript'> alert('Sorry! Not Available Big Size Room ')</script>";
								}
								else if($f2 =="NONE")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Small Size Room')</script>";
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														if($troom==" BigSizeRoom")
														{
															$type_of_room =20000;
														
														}
														else if($troom==" SmallSizeRoom")
														{
															$type_of_room = 15000;
														}
														...
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`, `troom`, `tbed`, `nroom`, `cin`, `cout`, `ttot`, `btot`,`fintot`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$troom','$bed','$nroom','$cin','$cout','$ttot','$meal','$mepr','$btot','$fintot','$days')";
